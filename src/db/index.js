...
for (const col of [['contact_person', 'TEXT'], ['website', 'TEXT'], ['instagram_url', 'TEXT'], ['gmb_url', 'TEXT'], ['rating', 'REAL'], ['review_count', 'INTEGER'], ['top_positive', 'TEXT'], ['top_negative', 'TEXT'], ['has_ads', 'TEXT'], ['seo_audit', 'TEXT'], ['qualification_pipeline', 'TEXT'], ['segment', 'TEXT']]) {
